...
const About = () => {
  return (
    <div className={styles.about}>
      ...
      {/* Team Section */}
      <section className="team-introduction py-12">
        <h2 className="text-3xl font-bold text-center mb-6">Meet Our Team</h2>
        <div className="team-cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {teamMembers.map((member) => (
            <div key={member.name} className="team-card bg-white shadow-md rounded-lg p-6">
      ...
      <section className="value-proposition py-12">
        <div className="statement-container bg-royalblue text-white rounded-lg p-8 mb-8">
        ...
        <div className="statement-container bg-royalblue text-white rounded-lg p-8">
